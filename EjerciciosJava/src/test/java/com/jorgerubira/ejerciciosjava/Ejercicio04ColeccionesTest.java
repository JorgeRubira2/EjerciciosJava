...
public class Ejercicio04ColeccionesTest {
    ...
    public void testInsertarElementoEnLista() {
        ...
        instance.insertarElementoEnLista(1, destino);
        instance.insertarElementoEnLista(9, destino);
        instance.insertarElementoEnLista(10, destino);
        assertEquals(3, destino.size() );
        assertEquals(1L, destino.get(0) );
        assertEquals(9L, destino.get(1) );
        assertEquals(10L, destino.get(2) );
    }
    ...
    public void testInsertarElementoEnTabla() {
        ...
        Ejercicio04Colecciones instance = new Ejercicio04Colecciones();
        instance.insertarElementoEnTabla("Pepe", 2, destino);
        instance.insertarElementoEnTabla("Francisco", 6, destino);
        assertEquals(1, destino.size() );
        assertEquals(2, destino.get("Pepe") );
        assertEquals(6, destino.get("Francisco") );
    }

    @Test
    public void testCopiar() {
        List<Double> origen = Arrays.asList(1d);
        ...
        assertEquals(8d, destino.get(0) );
        assertEquals(18d, destino.get(1) );
        assertEquals(1d, destino.get(2) );
    }

    @Test
    public void testContarElementosEnSet() {
        List<Integer> lista = Arrays.asList(1,29,119,192,1,51,5);
        Set<Integer> enLista = Set.of(1,5,2,3);
        Ejercicio04Colecciones instance = new Ejercicio04Colecciones();
        int resultado = instance.contarElementosEnSet(lista, enLista);
