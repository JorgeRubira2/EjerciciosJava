...
public class Ejercicio06Lambdas {
    ...
    public Comparator<String> compararStrings() {
        ...
        return (p1, p2) -> (p1 != null && p2 != null) ? p1.compareTo(p2) : (p1 == null && p2 == null) ? 0 : p1 == null ? -1 : 1;
        // throw new RuntimeException("Pendiente de hacer");
    }
    ...
    public Comparator<Persona> compararPersonasPorCiudadYNombre() {
        ...
        return (p1, p2) -> p1.getCiudad().compareTo(p2.getCiudad()) != 0 ? p1.getCiudad().compareTo(p2.getCiudad()) : p1.getNombre().compareTo(p2.getNombre());
        //throw new RuntimeException("Pendiente de hacer");
    }
    ...
    public Predicate<Persona> esLaPersonaDeHuesca() {
        return (p1) -> p1.getCiudad() == null || !p1.getCiudad().equals("Huesca") ? false : true;
    }
    ...
    public Predicate<Persona> esEnEdadLaboral() {
        return (p1) -> p1.getEdad() >= 16 && p1.getEdad() < 64 ? true : false;
    }
    ...
    public IComparadorPersonaCompra miCompraEsMayorQueOtra() {
        return (p1, p2) -> {
            ...
            if (p2.isEmpty()) {
                ...
                a = p2.get().getTotalArticulos();
            }
            if (p1.getCesta().isEmpty()) {
                b = 0;
            } else {
                b = p1.getCesta().get().getTotalArticulos();
            }
            if (a < b) {
                return true;
            } else {
