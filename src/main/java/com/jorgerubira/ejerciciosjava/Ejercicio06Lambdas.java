...
public class Ejercicio06Lambdas {
    ...
    public Comparator<Persona> compararPersonasPorCiudadYNombre() {
        return (v1, v2) -> {
            if (v1.getCiudad().compareTo(v2.getCiudad()) != 0) {
                return v1.getCiudad().compareTo(v2.getCiudad());
            } else {
    ...
    public Predicate<Persona> esLaPersonaDeHuesca() {
        return (v1) -> {
            if (v1.getCiudad() == "Huesca") {
                return true;
            } else if (v1.getCiudad() == null) {
                return false;
            } else {
                return false;
            }
