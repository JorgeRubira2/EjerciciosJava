...
public class Ejercicio03Comparadores {
    ...
    public boolean compararEnteros(Integer i1, Integer i2){
        ...
        else if(i1.equals(i2))return true;
        else return false;
    }
    ...
    public boolean compararEnteroConLong(Integer i1, Long i2){
        if(i1==null || i2==null)return false;
        else if((long)i1==i2)return true;
        else return false;
    }    
    ...
    public boolean comprobarOptionalConInteger(Optional<Integer> valor1, Integer valor2){
      if(valor1.isEmpty() || valor2==null)return false;
        else if(valor1.get().equals(valor2))return true;
        else return false;
    }    
    ...
    public boolean comprobarOptionalesIntegerYDouble(Optional<Integer> valor1, Optional<Double> valor2){
        if(valor1.isEmpty() || valor2.isEmpty())return false;
        else if(valor2.get().equals(Double.valueOf(valor1.get()))) return true;
        else return false;
    }    
