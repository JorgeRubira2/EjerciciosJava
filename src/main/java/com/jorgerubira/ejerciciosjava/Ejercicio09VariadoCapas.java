...
public class Ejercicio09VariadoCapas {
    ...
    /**
     * Calcular el total de productos comprados por las personas de una ciudad entre dos fechas.
     * Será necesario leer personas utilizando IPersonasRepository y las compras utilizando IComprasRepository 
    ...
    /**
     * Nos envian una lista de compras realizadas y debemos calcular el importe pasado por la aduana.
    ...
    /**
     * Recibimos una lista de personas y deseamos calcular el total ingresado por aduana obtenido entre dos fechas.
     * Estas personsa no tienen la compra informada por lo que la tendremos que obtener utilizando IComprasRepository
     * Para el cálculo del precio utilizar el servicio IAduanaService.
     */
    ...
    /**
     * Recibimos una lista de personas que tienen cestas de compra con detalle de producto.
     * Se pide devolver cuantos ingresos a traves de la aduana hemos obtenido por productos hay de cada tipo de producto y devolver la información ordenada de mayor a menos. (El tipo más vendido al menos)
     * Utilizaremos el servicio de la aduana para obtener 
     * Para ello devolveremos una tupla (Pair en el que el primer valor sea el nombre del tipos y el segundo sea cuantas veces aparece).
     */
