...
public class Ejercicio09VariadoCapasTest {
    ...
    @Mock private IPersonasRepository iperExtenso;
    @Mock private IPersonasRepository iper;
    @Mock private IComprasRepository icomConRetardo;
    @Mock private IComprasRepository icom;
    @Mock private IAduanaService iadu;    
    @Mock private IAduanaService iaduCaso2;
    @Mock private IComprasRepository icomCaso2;
    ...
    public void inicializarMocks(){
        ...
        Mockito.when(iperExtenso.buscarPersonaEntreFechas(Mockito.any(Date.class), Mockito.any(Date.class))).thenThrow(new Exception("Parametro incorrecto"));
